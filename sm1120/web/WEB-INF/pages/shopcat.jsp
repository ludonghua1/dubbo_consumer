    ...
    <script>
            ...
            $.ajax({
                    ...
                    success:function (data) {
                        ...
                        if (data=='success') {
                            ...
                            $.ajax({
                                    type:"post",
                                    url:"${path}/delCookieShopping.action",
                                    data:{"ids":ids},
                                    success:function (data) {
                                        //data就是服务端响应的内容
                                        if (data=='1') {
        ...
        function buyer() {
            ...
            if (ids == "") {
                ...
                $.ajax({
                    type: 'post',
                    url: '<%=request.getContextPath()%>/makeOrders.action',
                    data: {"ids": ids},
                    success: function (data) {
                        if (data == "success") {
                            alert("订单已生成！");
                            window.location.href = "<%=request.getContextPath()%>/toOrders.action";
                        }
