                 ...
                 <!-- 
                  ...
                  -->
					<ul class="page">
					    ...
					    <a href="${ctx}/index/notice.shtml?pageNo=${pageSize}&pageSize=10" style="background: #C30D23 none repeat scroll 0% 0%;color:#ffffff;">${pageSize}</a>
					     </c:when>
					   <c:otherwise>
					   <a href="${ctx}/index/notice.shtml?pageNo=${pageSize}&pageSize=10" >${pageSize}</a>
					   </c:otherwise>
					   </c:choose>
