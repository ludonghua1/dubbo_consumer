                        ...
                        <div class="box-staman">
                            ...
                            <div class="box-extpub">
                                ...
                                <ul class="ul-img-z">
                                    <li>
                                        <div class="img" >
                                        <a href="javascript:void(0)"  onclick="<c:if test="${empty salebusiness.picurl1}">addPic(1)</c:if><c:if test="${not empty salebusiness.picurl1}">updatePic(1)</c:if>"><img src="${ctx}/images/z-ad1.jpg" alt="" /></a>
                                    ...
                                    <li>
                                        <div class="img" >
                                                ...
                                                <a href="javascript:void(0)" onclick="<c:if test="${empty salebusiness.picurl2}">addPic(2)</c:if><c:if test="${not empty salebusiness.picurl2}">updatePic(2)</c:if>"><img src="${ctx}/images/z-ad2.jpg" alt="" /></a>
                                    ...
                                    <li>
                                        <div class="img" >
                                                <a href="javascript:void(0)"onclick="<c:if test="${empty salebusiness.picurl3}">addPic(3)</c:if><c:if test="${not empty salebusiness.picurl3}">updatePic(3)</c:if>"><img src="${ctx}/images/z-ad2.jpg" alt="" /></a>
                                        </div>
                                        <div class="txt">
                                                <p><a href=""></a></p>
                                        </div>
